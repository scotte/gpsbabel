...
static void raycoord_norm(int32_t, int32_t, double *, double *);
void output_wpt(const fsh_wpt_data_t *, const ellipsoid_t *, int64_t);
int wpt_01_output(const fsh_block_t *, const ellipsoid_t *);
char *guid_to_string(uint64_t );
int fsh_read_file_header(gbfile* , fsh_file_header_t *);
int fsh_read_flob_header(gbfile* , fsh_flob_header_t *);
fsh_block_t *fsh_block_read(gbfile* , fsh_block_t *);
